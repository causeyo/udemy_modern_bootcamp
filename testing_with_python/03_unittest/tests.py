...
unittest - builtin module - test framework
- you can write unit tests encapsulated as classes that inherit from unittest.TestCase
- this inheritance gives you access to many assertions helpers
- you can run test by calling unittest.main()

- to execute tests with docstrings please use command: python3 tests.py -v
"""
