...
class Moderator(User):
    ...
    def display_active_mods(cls):
        return "There are currently {} active mods".format(Moderator.total_mods)

    def remove_post(self):
        return "{} remove post from {} community".format(self.full_name(), self.community)
...
mod1 = Moderator("Wi", "Fon", 42, "news.com")
print(User.display_active_users())
print(Moderator.display_active_mods())